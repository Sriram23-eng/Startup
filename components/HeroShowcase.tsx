...
export default function HeroShowcase({
  ...
  kits: ShowcaseKit[];
  /** Bare = just the crossfading image stage (fills its parent), no outer
      frame or floating chips. For embedding inside a bento cell. */
  bare?: boolean;
}) {
  ...
  // Bare: just the stage, filling the parent (for bento cells).
  if (bare) {
    return (
      <div
