  ...
  nav: [
    {
      ...
      children: [
        {
          label: "Ready-Made Kits",
          href: "/projects",
          desc: "IoT, AI, LoRa, robotics & more",
        },
    ...
    },
    {
      ...
      href: "/workshops",
      children: [
        { label: "Online Workshops", href: "/workshops/online", desc: "Live, from anywhere" },
        { label: "Offline & Field", href: "/workshops/offline", desc: "On-campus & on-site" },
        { label: "FDP & Bootcamps", href: "/workshops/fdp", desc: "Faculty & student programs" },
        { label: "Corporate Training", href: "/workshops/corporate", desc: "Upskill your team" },
      ],
    },
